...
MATH_UNITS = {
    ...
    3: [
        ("1. 곱셈", "구구단을 이용하여 곱셈을 할 수 있다.", "곱셈", 1),
        ("2. 나눗셈", "나눗셈의 의미와 계산을 할 수 있다.", "나눗셈", 1),
        ("3. 분수", "분수의 의미와 크기를 비교할 수 있다.", "분수", 2),
    ],
    4: [
        ("1. 큰 수", "억 단위까지의 수를 읽고 쓸 수 있다.", "큰 수", 1),
        ("2. 곱셈과 나눗셈", "두 자리 수의 곱셈과 나눗셈을 할 수 있다.", "곱셈 나눗셈", 1),
        ("3. 분수와 소수", "분수와 소수의 관계를 이해한다.", "분수 소수", 2),
    ],
    5: [
        ("1. 약수와 배수", "약수와 배수, 공약수, 공배수를 이해한다.", "약수 배수", 1),
        ("2. 분수의 덧셈과 뺄셈", "분수의 덧셈과 뺄셈을 할 수 있다.", "분수 연산", 1),
        ("3. 다각형의 넓이", "삼각형, 사다리꼴, 평행사변형의 넓이를 구한다.", "넓이", 2),
    ],
    6: [
        ("1. 분수의 나눗셈", "분수의 나눗셈을 할 수 있다.", "분수 나눗셈", 1),
        ("2. 비와 비율", "비와 비율을 이해하고 활용한다.", "비 비율", 1),
        ("3. 원의 넓이와 둘레", "원의 넓이와 둘레를 구할 수 있다.", "원", 2),
    ],
    7: [
        ("1. 정수와 유리수", "정수와 유리수를 이해한다.", "정수 유리수", 1),
        ("2. 문자와 식", "문자를 사용하여 식을 세우고 계산한다.", "식", 1),
        ("3. 일차방정식", "일차방정식을 풀 수 있다.", "방정식", 2),
    ],
    8: [
        ("1. 식의 계산", "다항식의 덧셈, 뺄셈, 곱셈을 할 수 있다.", "다항식", 1),
        ("2. 연립방정식", "연립방정식을 풀 수 있다.", "연립방정식", 1),
        ("3. 일차함수", "일차함수의 그래프와 성질을 이해한다.", "함수", 2),
    ],
    9: [
        ("1. 제곱근과 실수", "제곱근과 실수를 이해한다.", "제곱근", 1),
        ("2. 인수분해", "다항식을 인수분해할 수 있다.", "인수분해", 1),
        ("3. 이차방정식", "이차방정식을 풀 수 있다.", "이차방정식", 2),
    ],
}
...
KOREAN_UNITS = {
    ...
    3: [
        ("1. 문학", "동시와 이야기 감상", "동화", 1),
        ("2. 문법", "문장의 성분과 품사", "품사", 2),
    ],
    4: [
        ("1. 문학", "시와 산문 읽기", "시", 1),
        ("2. 쓰기", "글의 구조와 문단", "문단", 2),
    ...
    5: [
        ("1. 문법", "효음과 어미", "어미", 1),
        ("2. 문학", "고전 소설과 현대 소설", "소설", 2),
    ],
    6: [
        ("1. 문학", "수필과 극", "수필", 1),
        ("2. 문법", "문장 부호와 띄어쓰기", "맞춤법", 2),
    ],
    7: [
        ("1. 문학", "현대 시와 산문", "현대시", 1),
        ("2. 문법", "품사와 문장 성분", "문장성분", 2),
    ],
    8: [
        ("1. 문학", "고전 산문과 시", "고전", 1),
        ("2. 쓰기", "논술문 쓰기", "논술", 2),
...
SOCIAL_UNITS = {
    ...
    7: [
        ("1. 역사", "인류 문명", "문명", 1),
        ("2. 지리", "세계의 다양한 지역", "세계", 2),
    ],
    8: [
        ("1. 역사", "근대 국가 형성", "근대국가", 1),
        ("2. 사회·정치", "권력과 시민", "시민", 2),
    ],
    9: [
        ("1. 역사", "근현대 세계", "근현대", 1),
...
ENGLISH_UNITS = {
    ...
    3: [
        ("1. My Hobby", "취미 표현", "hobby", 1),
        ("2. My Favorite Food", "음식 표현", "food", 2),
    ],
    4: [
        ("1. Where Are You?", "장소와 방향", "place direction", 1),
        ("2. My Weekend", "과거 경험", "past experience", 2),
    ],
    5: [
        ("1. My Future", "미래 계획", "future plan", 1),
        ("2. Our Earth", "지구와 환경", "environment", 2),
    ],
    6: [
        ("1. My Dream", "직업과 꿈", "dream job", 1),
        ("2. Around the World", "세계 문화", "world culture", 2),
    ],
    7: [
        ("1. Me and My Friends", "성격과 외모", "personality appearance", 1),
        ("2. Healthy Life", "건강과 생활", "health", 2),
    ],
    8: [
        ("1. Inventions", "발명과 과학", "invention", 1),
        ("2. Our Traditions", "전통과 문화", "tradition", 2),
    ],
    9: [
        ("1. Communication", "의사소통 방법", "communication", 1),
        ("2. Our Future", "미래 사회", "future society", 2),
    ],
}
    ...
    for grade, units in MATH_UNITS.items():
        for order, (name, objective, keywords, semester) in enumerate(units, start=1):
            db.session.add(CurriculumUnit(
                subject="math", grade_level=grade, semester=semester, unit_order=order,
                unit_name=name, learning_objective=objective, keywords=keywords
            ))
    for grade, units in KOREAN_UNITS.items():
        for order, (name, objective, keywords, semester) in enumerate(units, start=1):
            db.session.add(CurriculumUnit(
                subject="korean", grade_level=grade, semester=semester, unit_order=order,
                unit_name=name, learning_objective=objective, keywords=keywords
            ))
    for grade, units in SOCIAL_UNITS.items():
        for order, (name, objective, keywords, semester) in enumerate(units, start=1):
            db.session.add(CurriculumUnit(
                subject="social", grade_level=grade, semester=semester, unit_order=order,
                unit_name=name, learning_objective=objective, keywords=keywords
            ))
